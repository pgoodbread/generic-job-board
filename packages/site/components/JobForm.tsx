...
export default function JobForm({
  ...
  const [stickPreviewToTop, setStickPreviewToTop] = useState(false);
          ...
          <Form className="flex flex-col justify-center">
            <div className="lg:px-24 py-4 px-4">
              <FormInput
                ...
                type="text"
                onFocus={() => setStickPreviewToTop(true)}
                onBlur={() => setStickPreviewToTop(false)}
              />
              <FormInput
                name="company"
                type="text"
              ...
              <ButtonStyle>
                <button
                  type="submit"
                  className="disabled:cursor-wait h-auto w-full text-xl flex justify-center items-center lg:hidden mt-4"
                >
                  {isSubmitting ? (
                    <>
                      <svg
            ...
            <div
              className={clsx(
                "fixed bg-white w-full z-10 lg:pt-2 md:z-0 lg:bg-gray-100",
                { "top-0": stickPreviewToTop, "bottom-0": !stickPreviewToTop }
              )}
            >
              <div className="flex">
